...
const projects: Project[] = [
    ...
    },
    {
        ...
        githubUrl: 'https://github.com/HONGKINGNIRMOND/Portfolio',
        ...
        >
            ...
            <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="mt-auto flex justify-end space-x-4">
                    {project.liveUrl && (
                        <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="text-light-text-alt dark:text-dark-text-alt hover:text-light-primary dark:hover:text-dark-primary transition-colors duration-300">
                           <ExternalLinkIcon className="w-6 h-6" />
                        </a>
                    )}
                    <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="text-light-text-alt dark:text-dark-text-alt hover:text-light-primary dark:hover:text-dark-primary transition-colors duration-300">
